...
public class YamlCollectionPolicy
{
    ...
    [YamlMember(Alias = "deltaView")]
    public YamlDeltaViewSettings? DeltaView { get; set; }

    [YamlMember(Alias = "limits")]
    public YamlCollectionLimits? Limits { get; set; }
    ...
    [YamlMember(Alias = "m2m")]
    public YamlM2MSettings? M2M { get; set; }
}

public class YamlDeltaViewSettings
{
    [YamlMember(Alias = "addedPrefix")]
    public string? AddedPrefix { get; set; }

    [YamlMember(Alias = "removedPrefix")]
    public string? RemovedPrefix { get; set; }

    [YamlMember(Alias = "joiner")]
...
{
    [YamlMember(Alias = "addedMax")]
    public int? AddedMax { get; set; }

    [YamlMember(Alias = "removedMax")]
    public int? RemovedMax { get; set; }
}
...
{
    [YamlMember(Alias = "joinEntity")]
    public string? JoinEntity { get; set; }

    [YamlMember(Alias = "joinFields")]
