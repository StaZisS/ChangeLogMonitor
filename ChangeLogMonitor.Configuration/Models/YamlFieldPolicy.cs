...
public class YamlFieldPolicy
{
    ...
    [YamlMember(Alias = "view")]
    public YamlViewSettings? View { get; set; }

    [YamlMember(Alias = "mask")]
    public YamlMaskSettings? Mask { get; set; }

    [YamlMember(Alias = "hash")]
    public YamlHashSettings? Hash { get; set; }

    [YamlMember(Alias = "encrypt")]
    public YamlEncryptSettings? Encrypt { get; set; }
}
...
public class YamlMaskSettings
{
    ...
    [YamlMember(Alias = "keepLeft")]
    public int? KeepLeft { get; set; }

    [YamlMember(Alias = "keepRight")]
    public int? KeepRight { get; set; }

    [YamlMember(Alias = "preserveDomain")]
    public bool? PreserveDomain { get; set; }

    [YamlMember(Alias = "preserveFormat")]
...
public class YamlHashSettings
{
    ...
    [YamlMember(Alias = "algo")]
    public string? Algo { get; set; }

    [YamlMember(Alias = "salt")]
    public YamlSaltSettings? Salt { get; set; }

    [YamlMember(Alias = "pepperRef")]
    public string? PepperRef { get; set; }

    [YamlMember(Alias = "encoding")]
    public string? Encoding { get; set; }

    [YamlMember(Alias = "storeRaw")]
    public bool? StoreRaw { get; set; }

    [YamlMember(Alias = "storeHash")]
    public bool? StoreHash { get; set; }

    [YamlMember(Alias = "equalityToken")]
...
public class YamlEncryptSettings
{
    ...
    [YamlMember(Alias = "keyRef")]
    public string? KeyRef { get; set; }

    [YamlMember(Alias = "aad")]
    public List<string>? Aad { get; set; }

    [YamlMember(Alias = "iv")]
    public YamlIvSettings? Iv { get; set; }
    ...
    public YamlRotateSettings? Rotate { get; set; }
}
