...
{
    [YamlMember(Alias = "showKey")]
    public bool? ShowKey { get; set; }

    [YamlMember(Alias = "showName")]
    public bool? ShowName { get; set; }

    [YamlMember(Alias = "viewTemplate")]
    public string? ViewTemplate { get; set; }

    [YamlMember(Alias = "nameMaskPreset")]
    public string? NameMaskPreset { get; set; }
}

public class YamlCollectionPreset
{
    [YamlMember(Alias = "logDeltas")]
    public bool? LogDeltas { get; set; }

    [YamlMember(Alias = "showKeys")]
    public bool? ShowKeys { get; set; }

    [YamlMember(Alias = "showNames")]
