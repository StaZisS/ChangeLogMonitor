...
public class YamlReferencePolicy
{
    ...
    [YamlMember(Alias = "nameSelector")]
    public string? NameSelector { get; set; }

    [YamlMember(Alias = "nameResolve")]
    public YamlNameResolveSettings? NameResolve { get; set; }

    [YamlMember(Alias = "nameMaskPreset")]
    public string? NameMaskPreset { get; set; }

    [YamlMember(Alias = "key")]
    public YamlKeySensitivitySettings? Key { get; set; }

    [YamlMember(Alias = "nullTransitions")]
    public string? NullTransitions { get; set; }

    [YamlMember(Alias = "changedAs")]
...
public class YamlKeySensitivitySettings
{
    ...
    [YamlMember(Alias = "maskPreset")]
    public string? MaskPreset { get; set; }

    [YamlMember(Alias = "hashPreset")]
