...
{
    [JsonPropertyName("tx_id")] public string TxId { get; init; } = string.Empty;
    ...
    [JsonPropertyName("stats")] public TxAggregateStats Stats { get; init; } = new();
}
...
public sealed class TxAggregateEvent
{
    ...
    [JsonPropertyName("ts_ms")] public long TimestampMs { get; init; }

    [JsonPropertyName("total_order")] public long? TotalOrder { get; init; }
...
public sealed class TxAggregateStats
{
    ...
    [JsonPropertyName("received_total")] public int ReceivedTotal { get; init; }
